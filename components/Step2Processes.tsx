    ...
    return (
        <div className="space-y-4 animate-fade-in">
            <div className="text-center mb-4 md:mb-8">
                <h2 className="text-2xl md:text-3xl font-bold font-sans text-white mb-2">Attività Manuali</h2>
                <p className="text-gray-400 text-sm md:text-base">Per i reparti selezionati, spunta le attività che svolgete manualmente.</p>
            </div>
                    ...
                    return (
                        <div key={dept.id} className={`border rounded-xl transition-all duration-300 overflow-hidden ${isOpen ? 'border-primary/50 bg-bg-card' : 'border-white/10 hover:border-white/20 bg-bg-card/50'}`}>
                            ...
                            <button
                                ...
                                className="w-full p-3 md:p-5 flex items-center justify-between"
                            >
                                <div className="flex items-center gap-3 md:gap-4">
                                    <div className={`p-1.5 md:p-2 rounded-lg ${isOpen ? 'bg-primary text-white' : 'bg-white/10 text-gray-400'}`}>
                                        <Icon size={20} className="md:w-6 md:h-6" />
                                    </div>
                                    <div className="text-left">
                                        <h3 className="font-bold text-base md:text-lg text-white">{dept.name}</h3>
                                        <p className="text-[10px] md:text-xs text-gray-400">{activeCount} attività selezionate</p>
                                    </div>
                                </div>
